...
> Relocated out of `CLAUDE.md` (rule-review Check 4): this is toolkit documentation, not project onboarding. The skills self-document when invoked; this file is reference material only.
